...
const socialLinks = [
  ...
  },
  {
    ...
    subText: '@bugslayer_404',
    icon: Instagram,
    url: 'https://www.instagram.com/bugslayer_404/',
    color: '#E4405F',
  ...
  },
  {
    ...
    subText: '@bugslayer_404',
    icon: Youtube,
    url: 'https://www.youtube.com/bugslayer_404',
    color: '#FF0000',
  ...
  },
  {
    name: 'GitHub',
    displayName: 'Github',
    subText: '@bugfinder404',
    icon: Github,
    url: 'https://github.com/bugfinder404',
    color: '#ffffff',
  ...
  },
  {
    ...
    url: 'https://tiktok.com/@bugfinder404',
    color: 'black',
